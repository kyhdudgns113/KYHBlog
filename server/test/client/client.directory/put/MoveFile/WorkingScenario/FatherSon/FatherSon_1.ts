...
export async function _1_1_SonFrontToParentFront(db: mysql.Pool, logLevel: number) {
  /**
   * 1-1. 자식 맨앞 -> 부모 맨앞
   */
  try {
    ...
    if (extraDirs) {
      ...
      if (oldParentDir.fileOIdsArr.length !== 9) {
        throw `1-4. oldParentDir 의 자식파일 길이가 9가 아닌 ${oldParentDir.fileOIdsArr.length} 이다.`
      }
      ...
      if (newParentDir.fileOIdsArr.length !== 11) {
        throw `1-8. newParentDir 의 자식파일 길이가 11가 아닌 ${newParentDir.fileOIdsArr.length} 이다.`
      }
...
export async function _1_2_ParentFrontToSonFront(db: mysql.Pool, logLevel: number) {
  /**
   * 1-2. 부모 맨앞 -> 자식 맨앞
   */
  try {
...
export async function _1_3_SonFrontToParentMiddle(db: mysql.Pool, logLevel: number) {
  /**
   * 1-3. 자식 맨앞 -> 부모 가운데
   */
  try {
...
export async function _1_4_ParentMiddleToSonFront(db: mysql.Pool, logLevel: number) {
  /**
   * 1-4. 부모 가운데 -> 자식 맨앞
   */
  try {
...
export async function _1_5_SonFrontToParentBack(db: mysql.Pool, logLevel: number) {
  /**
   * 1-5. 자식 맨앞 -> 부모 맨뒤
   */
  try {
...
export async function _1_6_ParentBackToSonFront(db: mysql.Pool, logLevel: number) {
  /**
   * 1-6. 부모 맨뒤 -> 자식 맨앞
   */
  try {
