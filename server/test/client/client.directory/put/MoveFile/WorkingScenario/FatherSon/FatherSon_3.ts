...
export async function _1_13_SonBackToParentFront(db: mysql.Pool, logLevel: number) {
  /**
   * 1-13. 자식 맨뒤 -> 부모 맨앞
   */
  try {
...
export async function _1_14_ParentFrontToSonBack(db: mysql.Pool, logLevel: number) {
  /**
   * 1-14. 부모 맨앞 -> 자식 맨뒤
   */
  try {
...
export async function _1_15_SonBackToParentMiddle(db: mysql.Pool, logLevel: number) {
  /**
   * 1-15. 자식 맨뒤 -> 부모 가운데
   */
  try {
...
export async function _1_16_ParentMiddleToSonBack(db: mysql.Pool, logLevel: number) {
  /**
   * 1-16. 부모 가운데 -> 자식 맨뒤
   */
  try {
...
export async function _1_17_SonBackToParentBack(db: mysql.Pool, logLevel: number) {
  /**
   * 1-17. 자식 맨뒤 -> 부모 맨뒤
   */
  try {
...
export async function _1_18_ParentBackToSonBack(db: mysql.Pool, logLevel: number) {
  /**
   * 1-18. 부모 맨뒤 -> 자식 맨뒤
   */
  try {
